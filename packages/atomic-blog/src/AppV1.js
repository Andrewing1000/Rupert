...
const PostContext = createContext() //createContext(<objectX>) objectX is inmutable for the rest of its lifetime
...
function App() {
  ...
  return (
    <PostContext.Provider value={{
      ...
      topic related  Providers, for instance
      A post related one and another query and its setter*/}
      <section>
        <button
...
//COntect API: useContext
//broadcast global state to the entire app
